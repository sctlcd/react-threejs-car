...
export function Ground() {
  ...
  return (
    ...
    >
      ...
      {/* Define MeshReflectorMaterial. This material extends from THREE.MeshStandardMaterial and accepts all its props.
      ...
      // props extended from from THREE.MeshStandardMaterial: https://threejs.org/docs/#api/en/materials/MeshStandardMaterial
        aoMap={aoMap} // the red channel of this texture is used as the ambient occlusion map. Default is null. The aoMap requires a second set of UVs.
        ...
        // props from MeshReflectorMaterial: https://github.com/pmndrs/drei#meshreflectormaterial
